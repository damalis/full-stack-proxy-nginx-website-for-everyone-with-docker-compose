...
<p align="left"> <a href="https://www.php.net" target="_blank" rel="noreferrer"> <img src="https://raw.githubusercontent.com/github/explore/ccc16358ac4530c6a69b1b80c7223cd2744dea83/topics/php/php.png" alt="php" height="40" width="40"/> </a>&nbsp;&nbsp;&nbsp; 
...
```
git clone https://github.com/damalis/full-stack-proxy-nginx-website-for-everyone-with-docker-compose.git
```

Open a terminal and `cd` to the folder in which `docker-compose.yml` is saved and run:

```
cd full-stack-proxy-nginx-website-for-everyone-with-docker-compose
chmod +x install.sh
./install.sh
```
...
The containers are now built and running. You should be able to access the Website with the configured IP in the browser address. `https://example.com`.
...
The extension makes it possible to interact with a running varnish instance through TCP socket or shared memory. [Varnish](https://www.php.net/manual/tr/book.varnish.php).

Varnish Server Host = varnish
