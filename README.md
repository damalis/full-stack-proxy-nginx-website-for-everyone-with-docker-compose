...
```
docker volume create --driver local --opt type=none --opt device=/home/ubuntu/full-stack-proxy-nginx-website-for-everyone-with-docker-compose/certbot --opt o=bind certbot-etc
```
